/* animals.c -- use switch statement */
#include <stdio.h>
#include <ctype.h>
int main (void)
{
	...
	printf("Please type in a letter; type # to end your act.\n");
	while ((ch = getchar()) != '#')
	{
		if (ch == '\n')
			continue;
		if (islower (ch))	/* only identify lowercase letters */
			switch (ch)
			{
		...
		while (getchar() != '\n')
			continue;	/* skip the rest of input row */
